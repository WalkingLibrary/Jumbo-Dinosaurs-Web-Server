...
public class OldMinecraftSign
{
    ...
    public OldMinecraftSign(int x, int y, int z, String text1, String text2, String text3, String text4, String date, int dimension)
    {
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public boolean equals(OldMinecraftSign sign)
    {
        if(this.x == sign.getX() &&
                this.y == sign.getY() &&
                this.z == sign.getZ() &&
